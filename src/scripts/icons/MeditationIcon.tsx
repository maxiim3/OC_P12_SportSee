 ...
 * # MeditationIcon
 *
 * @description Render a meditation icon to use it in the webpage.
 *
 * @returns {JSX.Element} -  SVG with the meditation icon structure.
 *
 * @example <MeditationIcon />
 */
